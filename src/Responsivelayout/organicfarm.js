...
import orgim from'./tomato.jpeg';
function Organicfram(){
    return(
        <>
        <div className='container-fluid orgbg'>
            <div className='row'>
                <div className='col-lg-6 or1'>
                    <h3 className='orgh3 text-color-white'>Organicfram</h3>
                    <h1 className='orgh1'>Of Organic Foods</h1>
